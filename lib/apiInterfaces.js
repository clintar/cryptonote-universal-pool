...
module.exports = function(daemonConfig, walletConfig, poolApiConfig, purchasesWalletConfig){
    return {
		...
		rpcPaymentWallet: function(method, params, callback){
            rpc(purchasesWalletConfig.host, purchasesWalletConfig.port, method, params, callback);
        },
