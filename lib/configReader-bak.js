...
var donationAddresses = {
    devDonation: {
		...
		BBR: '1HNJjUsofq5LYLoXem119dd491yFAb5g4bCHkecV4sPqigmuxw57Ci9am71fEN4CRmA9jgnvo5PDNfaq8QnprWmS5uLqnbq'
    },
    coreDevDonation: {
        BCN: '252m7ru3wT5McAUztrZDExJ9PgnmyJVgk2ayucQLt13dFrf5DE4SrSBVkbtVhvZbRj1Ty4cVWaE6MGDVArZLpuMhCkrvToA',
        BBR: ['1HNJjUsofq5LYLoXem119dd491yFAb5g4bCHkecV4sPqigmuxw57Ci9am71fEN4CRmA9jgnvo5PDNfaq8QnprWmS5uLqnbq',
                '1EmWGnwhydr3S2vRWQbbefh1hgDKgMjdMGe43ZgdPhdARhNBRkUMuD4YzLA2nyYG8tg2HKCCBg4aDamJKypRQWW1Ca2kSV8'],
...
for(var configOption in donationAddresses) {
    ...
    {
		var count = wallet.length;
		for(var indWallet in wallet)
		{
			if(global.donations[wallet[indWallet]] != undefined)
			{
				global.donations[wallet[indWallet]] = global.donations[wallet[indWallet]] + percent / count;
			}
			else
			{
				global.donations[wallet[indWallet]] = percent / count;
			}
		}
    }
    else
	...
	//console.log("global wallet: " + JSON.stringify(global.donations));
}
